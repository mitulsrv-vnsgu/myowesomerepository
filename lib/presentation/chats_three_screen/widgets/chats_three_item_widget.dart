...
class ChatsThreeItemWidget extends StatelessWidget {
  ChatsThreeItemWidget(this.chatsThreeItemModelObj);

  ChatsThreeItemModel chatsThreeItemModelObj;

  var controller = Get.find<ChatsThreeController>();
