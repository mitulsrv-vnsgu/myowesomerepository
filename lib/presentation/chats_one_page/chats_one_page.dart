import '../chats_one_page/widgets/chats_one_item_widget.dart';
import 'controller/chats_one_controller.dart';
import 'models/chats_one_item_model.dart';
...
class ChatsOnePage extends StatelessWidget {
  ChatsOneController controller =
      Get.put(ChatsOneController(ChatsOneModel().obs));
                    ...
                    child: Obx(
                      () => ListView.separated(
                        ...
                        itemCount: controller
                            .chatsOneModelObj.value.chatsOneItemList.length,
                        itemBuilder: (context, index) {
                          ChatsOneItemModel model = controller
                              .chatsOneModelObj.value.chatsOneItemList[index];
                          return ChatsOneItemWidget(
                            model,
                          );
                        },
                      ),
