...
import '../models/likes_two_item_model.dart';
...
class LikesTwoItemWidget extends StatelessWidget {
  LikesTwoItemWidget(this.likesTwoItemModelObj, {this.onTapBtnFavorite});

  LikesTwoItemModel likesTwoItemModelObj;

  var controller = Get.find<LikesTwoController>();
